...
int main(int argc, char** argv)
{
    ...
    cout<<"RULES : --->\n\t* Use UP(^), DOWN(v), RIGHT(>), and LEFT(<) arrow keys to navigate with your snake.\n\t* Try neither to CRASH with the WALLS nor with your own BODY.\n\t* With each prey you eat, your score increases and so does your size.\n\t* You have to eat 25 preys to win in this game.\n\n";

    cout<<"When the game window opens to an empty window right-click on it and a difficulty selelctor will appear, choose your difficulty .\n";
